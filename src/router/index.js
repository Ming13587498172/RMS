  ...
  { path: '/login', component: () => import('@/views/Login') },
  {
    ...
    children: [
      ...
      { path: 'reports', name: 'reports', component: () => import('@/views/Reports') },
      {
        ...
        redirect: '/home/goods',
        children: [
          { path: '/home/goods', name: 'goods', component: () => import('@/views/Goods') },
          { path: '/home/goods/add', name: 'add', component: () => import('@/views/Add') }
        ]
      },
      // { path: 'goods', name: 'goods', component: () => import('@/views/Goods') },
      { path: 'goods/add', name: 'add', component: () => import('@/views/Add') },
